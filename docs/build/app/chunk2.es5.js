...
App.loadBundle("./chunk2.js", ["exports"], function (n) { window.App.h, n.createThemedClasses = function (n, e, t) { var r = {}; return t.split(" ").forEach(function (t) { return r[t] = !0, n && (r[t + "-" + n] = !0, e && (r[t + "-" + e] = !0, r[t + "-" + n + "-" + e] = !0)), r; }), r; }, n.getClassMap = function (n) { var e = {}; return function (n) { return n ? Array.isArray(n) ? n : n.split(" ").filter(function (n) { return "" !== n.trim(); }) : []; }(n).forEach(function (n) { return e[n] = !0; }), e; }, n.openURL = function (n, e, t) {
    if (t === void 0) { t = !1; }
